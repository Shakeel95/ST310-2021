...
Note the pipe operator allways passes the object to the **first** argument of the function to the right of the pipe operator. Tyr to understand why the following code breaks: 
```{r}
